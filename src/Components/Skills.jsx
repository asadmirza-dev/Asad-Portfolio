...
const Skills = () => {
  const skillCategories = [
    {
      ...
      skills: ["React.js", "JavaScript (ES6+)", "Tailwind CSS", "GSAP Animations", "HTML5 & CSS3", "Responsive UI/UX"]
    },
    {
      id: 2,
  ...
  "Authentication Concepts"
    ...
    },
    {
      ...
      skills: ["Git & GitHub", "VS Code", "Vercel", "Web3Forms Integration", "Postman", ]
    }
  ];

  return (
    <section className="bg-neutral-950 text-white py-24 px-4 sm:px-8 lg:px-16 relative border-b border-neutral-900" id="skills">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight">
            Skills & <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-emerald-400 to-purple-500">Tools</span>
          </h2>
